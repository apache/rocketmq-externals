...
import (
	...
	"github.com/apache/rocketmq-externals/rocketmq-knative/source/pkg/client/clientset/versioned/scheme"
...
func (c *SourcesV1alpha1Client) RocketMQSources(namespace string) RocketMQSourceInterface {
	return newRocketMQSources(c, namespace)
}
