...
import org.apache.rocketmq.replicator.redis.cmd.impl.LInsertCommand;
import org.apache.rocketmq.replicator.redis.cmd.impl.LInsertType;
...
public class LInsertParserTest {
    ...
    public void parse() throws Exception {
        ...
        Assert.assertEquals(LInsertType.BEFORE, cmd.getlInsertType());
