...
public class MqttPubrelMessageProcessor implements MqttRequestProcessor {
    private static final Logger log = LoggerFactory.getLogger(MqttPubrelMessageProcessor.class);

    private final MqttBridgeController mqttBridgeController;

    public MqttPubrelMessageProcessor(MqttBridgeController mqttBridgeController) {
