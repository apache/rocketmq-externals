...
public abstract class MqttRemotingServerAbstract extends MqttRemotingAbstract {
    private static final InternalLogger log = InternalLoggerFactory.getLogger(RemotingHelper.ROCKETMQ_REMOTING);

    public MqttRemotingServerAbstract() {
        super();
    }

    public MqttRemotingServerAbstract(final int permitsOneway) {
        super(permitsOneway);
    }
