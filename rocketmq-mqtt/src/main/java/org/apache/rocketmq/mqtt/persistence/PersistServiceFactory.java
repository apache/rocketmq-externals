...
public class PersistServiceFactory {
    ...
    public PersistService createPersistService(String persistServiceType) {
        return ServiceProvider.createInstance(paths.get(persistServiceType), PersistService.class);
    }
}
