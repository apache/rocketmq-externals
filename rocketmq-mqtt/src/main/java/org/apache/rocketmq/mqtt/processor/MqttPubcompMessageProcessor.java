...
public class MqttPubcompMessageProcessor implements MqttRequestProcessor {
    private static final Logger log = LoggerFactory.getLogger(MqttPubcompMessageProcessor.class);

    private final MqttBridgeController mqttBridgeController;

    public MqttPubcompMessageProcessor(MqttBridgeController mqttBridgeController) {
