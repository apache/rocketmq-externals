...
func main() {
	...
	//var clientConfig = &rocketmq_api_model.ClientConfig{}
	//clientConfig.SetNameServerAddress("127.0.0.1:9876")
	//rocketMqManager := rocketmq.MqClientManagerInit(clientConfig)
