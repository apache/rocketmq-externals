...
//        Assertions.assertThat(this.context.getBeansOfType(DefaultRocketMQListenerContainer.class)).isEmpty();
//
...
//        Assertions.assertThat(listenerContainer.getSelectorType()).isEqualTo(SelectorType.TAG);
...
//    }
    ...
    public void RocketMQAutoConfigurationNotCreatedByDefault(){
        runner.run(context -> context.getBean(RocketMQAutoConfiguration.class));
    }


    @Test(expected = NoSuchBeanDefinitionException.class)
    public void DefaultMQProducerNotCreatedByDefault(){
