...
docker build -t apache/rocketmq-namesrv:4.3.0-k8s ./kubernetes/rocketmq-namesrv
docker build -t apache/rocketmq-broker:4.3.0-k8s ./kubernetes/rocketmq-broker
